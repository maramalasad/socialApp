...
export const listByUser = (userId, token) => {
    return fetch(`${process.env.REACT_APP_API_URL}/post/posts/by/${userId}`, {
        method: "GET",
        headers: {
            Accept: "application/json",
...
export const comment = (userId, token, postId, comment) => {
    return fetch(`${process.env.REACT_APP_API_URL}/post/comment/${postId}`, {
        method: "PUT",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
...
export const uncomment = (userId, token, postId, comment) => {
    return fetch(`${process.env.REACT_APP_API_URL}/post/uncomment/${postId}`, {
        method: "PUT",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
